  ...
  return (
    <section className='flex flex-col justify-center'>
        <div className="flex m-4 justify-evenly items-center gap-16">
          <div>
            ...
            <div className='mt-16'>
              ...
              <ul className="flex gap-16 items-center">
                ...
                <Link href='/'>
                  <div className='flex gap-2 bg-dark-2 dark:bg-light-e text-white dark:text-dark-2 px-8 py-2 rounded-2xl justify-center items-center hover:bg-light-blue'>
                    <h6 className='text-body-large font-semibold'>Resume</h6>
                    <Image className='float' src='/assets/icons/open_in_new.svg' alt='open' width={25} height={25}/>
                  </div>
                </Link>
              </ul>
            </div>
          ...
          <div>
            <Image src='/assets/images/hero_image.png' alt='hero image'width={400} height={400}/>
          </div>
        </div>
    </section>
  )
