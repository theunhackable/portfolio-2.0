  ...
  return (
    <section>
      <div id="about" className="flex flex-col justify-center gap-16 items-center">
        ...
        <div id='about-content' className='w-1/2 text-dark-5 dark:text-light-b text-body-medium max-xl:text-body-normal max-sm:text-body-small font-bold max-md:w-[90%] max-sm:w-[95%]'>
